    ...
    <div className="space-y-4">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={exportReport} className="btn-ghost" disabled={data.count === 0}>
      ...
      {data.count === 0 ? (
        ...
        <>
          ...
          <div className="grid lg:grid-cols-2 gap-4">
            <div className="card">
              <h3 className="font-semibold text-slate-900 mb-3">Daily Spending</h3>
            ...
            <div className="card">
              <h3 className="font-semibold text-slate-900 mb-3">Category Breakdown</h3>
              <ResponsiveContainer width="100%" height={260}>
                <PieChart>
                  <Pie
                    data={data.catData}
          ...
          <div className="card">
            <h3 className="font-semibold text-slate-900 mb-3">Budget vs Actual</h3>
            <ResponsiveContainer width="100%" height={Math.max(220, budgetCompare.length * 40)}>
              <BarChart data={budgetCompare} layout="vertical" margin={{ left: 60 }}>
                ...
                />
                <Legend />
                <Bar dataKey="budget" fill="#cbd5e1" name="Budget" radius={[0, 4, 4, 0]} />
          ...
          <div className="card">
            <h3 className="font-semibold text-slate-900 mb-3">Category Details</h3>
